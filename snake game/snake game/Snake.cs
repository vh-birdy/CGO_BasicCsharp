    ...
    class Program
    {
        ...
        void Update()
        {
            while (!gameOver)
            {
                ...
                if (reset) break;
                Thread.Sleep((getDelay)); //chay process trong vong 1000ml 
            }
            if (gameOver) Lose();
            int getDelay()
        ...
        void Render()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Diem cua ban:{0} | Diem cao nhat: {1} ", score, highscore);
        }
        //Xy ly game thua
        void Lose()
        {
